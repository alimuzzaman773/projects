<div ng-app="addContact" ng-controller="addContactFormController">
    <div class="card" id="">
        <div class="alert" id="error_msg">
            <div class="alert alert-danger text-center ng-hide" role="alert" id="messages" ng-show="msg"><div class="alert-text">{{msg}}</div></div>
        </div>
        ...
        <div class="card-body">
            <form class="row g-3 form" novalidate role="form" name="addContactForm" ng-submit="addContact()" method="post" id="addContact">
                <div class="col-md-6"> 
                ...
                <div class="col-12">
                    <input type="submit" name="submitContact" value="Add" class="btn btn-primary pull-right">
                </div>
            </form>
        </div>
    </div>
            ...
            <table class="table table-striped table-responsive text-center" id=""><!--contactList-->
                ...
                <tbody>
                    <tr ng-repeat="cont in contactList">
                        ...
                        <td>
                            <a href="" ng-click="editRow(cont.id)" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
                            <a href="" ng-click="deleteRow(cont.id)" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
